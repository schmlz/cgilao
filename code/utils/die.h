...
void die(bool condition, const char* x, int exit_code, const char* f, int l);
...
#endif
void __fwt_fancy_die_if_function__(bool condition, int exit_code, char const* f, int l, std::string frm, ...);

#define NOT_IMPLEMENTED { __fwt_not_implemented__(__PRETTY_FUNCTION__, __FILE__, __LINE__); }

void __fwt_not_implemented__(char const* func_name, char const* file_name, int line);
