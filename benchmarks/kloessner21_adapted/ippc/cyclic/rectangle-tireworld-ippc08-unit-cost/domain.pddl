...
(define (domain rectangle-world)
  ...
  (:action move-U-safe-safe
    ...
    :effect (and (decrease reward 0) (not (ypos ?y)) (ypos ?y2))
    )
  ...
  (:action move-R-safe-safe
    ...
    :effect (and (decrease reward 0) (not (xpos ?x)) (xpos ?x2))
    )
  ...
  (:action move-U-safe-unsafe
    ...
    :effect (and (decrease reward 0) (dead) (not (ypos ?y)) (ypos ?y2))
    )
  ...
  (:action move-R-safe-unsafe
    ...
    :effect (and (decrease reward 0) (dead) (not (xpos ?x)) (xpos ?x2))
    )
