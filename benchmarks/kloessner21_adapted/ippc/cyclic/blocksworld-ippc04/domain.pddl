(define (domain blocks-domain)
  ...
  (:action pick-up-from-table
    ...
    :effect (and (decrease reward 0) (probabilistic 3/4 (and (holding ?b) (not (emptyhand)) (not (on-table ?b)))))
  )
  (:action put-on-block
    :parameters (?b1 ?b2 - block)
    :precondition (and (holding ?b1) (clear ?b2))
    :effect (and (probabilistic 3/4 (and (on ?b1 ?b2) (emptyhand) (clear ?b1) (not (holding ?b1)) (not (clear ?b2)))
                           1/4 (and (on-table ?b1) (emptyhand) (clear ?b1) (not (holding ?b1))))  (decrease reward 0))
  )
  (:action put-down
    :parameters (?b - block)
    :precondition (holding ?b)
    :effect (and  (decrease reward 0) (on-table ?b) (emptyhand) (clear ?b) (not (holding ?b)))
  )
  (:action pick-tower
  ...
  (:action put-tower-down
    ...
    :effect (and (decrease reward 0) (on-table ?b2) (emptyhand) (not (holding ?b2)))
  )
)
